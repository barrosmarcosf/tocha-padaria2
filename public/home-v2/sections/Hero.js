// ============================================================
// HERO (FIEL AO CLAUDE DESIGN)
// ============================================================

const { useParallax } = window;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(105deg, oklch(10% 0.02 48 / 0.96) 0%, oklch(12% 0.018 50 / 0.7) 60%, oklch(12% 0.018 50 / 0.3) 100%)',
          }}
        />
      </div>
      ...
      >
        ...
        >
          Cada pão nasce de levain vivo, farinha de qualidade e tempo. Não tem
          atalho — tem respeito.
        </p>
      ...
      >
        <div
          style={{
            ...
            height: 48,
            background:
              'linear-gradient(to bottom, transparent, var(--amber))',
