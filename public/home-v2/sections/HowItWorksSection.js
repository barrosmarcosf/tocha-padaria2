// ============================================================
// COMO FUNCIONA — 4 etapas (Pedido → Produção → Aviso → Retirada)
// ============================================================
const HOW_STEPS = [
  {
    n: "01",
    label: "Pedido",
    title: "Peça com antecedência",
    desc: "Pedidos abertos de domingo a quinta-feira, até às 16h.",
    meta: "Dom – Qui · até 16h"
  },
  {
    n: "02",
    label: "Produção",
    title: "Fornada de sábado",
    desc: "Produzimos sob demanda na manhã do sábado. Cada pedido recebe seu lugar no forno.",
    meta: "Sábado · sob demanda"
  },
  {
    n: "03",
    label: "Aviso",
    title: "Mensagem no WhatsApp",
    desc: "Quando seu pedido estiver pronto, você recebe um aviso com instruções de retirada.",
    meta: "Notificação por WhatsApp"
  },
  {
    n: "04",
    label: "Retirada",
    title: "Retire a partir das 15h",
    desc: "Presencial em São João de Meriti ou via 99 / Uber Flash por sua conta.",
    meta: "Sábado · a partir 15h"
  }
];
